...
export default function Main(){
    ...
    useEffect(() => {
        ...
        axios.get('https://todo-backend-zeta-roan.vercel.app/todos')
            .then(response => {
    ...
    const addNote = (newNote) => {
        if (newNote.title.trim() !== "") {
            ...
            axios.post('https://todo-backend-zeta-roan.vercel.app/todos', data)
                .then(response => {
    ...
    const onEdit = (id, newTitle) => {
        ...
        if (noteIndex !== -1) {
            ...
            axios.put(`https://todo-backend-zeta-roan.vercel.app/todos/${documentId}`, { title: newTitle })
                .then(() => {
    ...
    const handleCheckboxChange = (id) => {
        ...
        axios.put(`https://todo-backend-zeta-roan.vercel.app/todos/${documentId}`, { isChecked: !isChecked[id] })
            .then(() => {
    ...
    const deleteNote = (id) => {
        const documentId = notes.find(note => note.id === id)._id;
        axios.delete(`https://todo-backend-zeta-roan.vercel.app/todos/${documentId}`)
            .then(() => {
